...
modified: Monday, July 10th 2023, 7:44:42 am  
tags:  
  - shapecreations  
  - docker  
  - containers  
...
Docker. (2022, August 12). *Docker Official Images*. Docker Documentation. <https://docs.docker.com/docker-hub/official_images/>  
