...
modified: Friday, June 9th 2023, 3:40:13 pm  
tags:  
  - shapecreations  
  - docker  
  - containers  
...
If you don’t require a dedicated `Dockerfile` and have found a suitable and verified image from DockerHub, you can use the command `docker pull IMAGE_NAME:VERSION` command to *pull* a local version of that image onto your local Docker Desktop . At your command line prompt issue the following command :  
