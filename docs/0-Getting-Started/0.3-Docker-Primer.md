...
modified: Friday, June 9th 2023, 6:15:43 am  
tags:  
  - shapecreations  
  - docker  
  - containers  
...
Docker will be the last installation you need to make on your host machine. Yay! The install process is fairly straight forward, just follow the instructions here : [Install Docker Engine](https://docs.docker.com/engine/install/). Once your Docker engine is revving, you will want to open Obsidian (or your note-taking app of choice) and VSCode (or your IDE of choice). We are ready to code!  
