...
modified: Saturday, July 8th 2023, 2:14:38 pm  
tags:  
  - shapecreations  
media: ""  
status: in-progress  
...
- `COPY [--chown=USER:GROUP] [--chmod=<permissions>] ["<src>",... "<dest>"]'  
  
##### `VOLUME`  
  
Volumes deserve a bit more of an explanation as they are a major concept in Docker at large. Volumes allow you to share files between the host and the image file system.  
